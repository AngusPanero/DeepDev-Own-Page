...
// MAIN
// ─────────────────────────────────────────────
export default function BusinessScraper({ googleApiKey, emailScraperEndpoint, maxResults = 60 }: Props) {
    ...
    const handleBulkSend = async (subject: string, message: string, files: File[], testMode = false, testEmail?: string) => {
        ...
        if (testMode && testEmail) {
            ...
            try {
                await axios.post(`${import.meta.env.VITE_API_URL}/api/send-bulk-email`,
            ...
            <header className="bs-page-header">
                ...
                <div className="bs-header-content">
                    ...
                    <h1 className="bs-page-title">
                        Buscador de <span style={{ color: accent }}>Rubros</span>
                    </h1>
